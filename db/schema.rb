...
ActiveRecord::Schema.define(version: 2020_05_24_213652) do
  ...
  create_table "spree_avatax_official_entity_use_codes", id: :serial, force: :cascade do |t|
    t.string "code"
    t.string "name"
    t.text "description"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["code"], name: "index_spree_avatax_official_entity_use_codes_on_code"
    t.index ["name"], name: "index_spree_avatax_official_entity_use_codes_on_name"
  end

  create_table "spree_avatax_official_transactions", id: :serial, force: :cascade do |t|
    t.integer "order_id", null: false
    t.string "transaction_type", null: false
    t.string "code", null: false
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["code"], name: "index_spree_avatax_official_transactions_on_code", unique: true
    t.index ["order_id"], name: "index_spree_avatax_official_transactions_on_order_id"
    t.index ["transaction_type"], name: "index_spree_avatax_official_transactions_on_transaction_type"
  end
  ...
  create_table "spree_line_items", id: :serial, force: :cascade do |t|
    ...
    t.string "avatax_uuid"
    t.index ["avatax_uuid"], name: "index_spree_line_items_on_avatax_uuid", unique: true
  ...
  create_table "spree_shipments", id: :serial, force: :cascade do |t|
    ...
    t.index ["avatax_uuid"], name: "index_spree_shipments_on_avatax_uuid", unique: true
  ...
  create_table "spree_users", id: :serial, force: :cascade do |t|
    ...
    t.index ["avatax_entity_use_code_id"], name: "index_spree_users_on_avatax_entity_use_code_id", unique: true
